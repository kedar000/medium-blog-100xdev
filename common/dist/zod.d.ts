import z from "zod";
export declare const signupZodCheck: z.ZodObject<{
    email: z.ZodString;
...
export declare const signinZodcheck: z.ZodObject<{
    email: z.ZodString;
    password: z.ZodString;
}, "strip", z.ZodTypeAny, {
    email: string;
...
export declare const createBlogZodCheck: z.ZodObject<{
    title: z.ZodString;
    content: z.ZodString;
}, "strip", z.ZodTypeAny, {
    title: string;
...
export declare const updateBlogZodCheck: z.ZodObject<{
    title: z.ZodString;
    content: z.ZodString;
    id: z.ZodString;
}, "strip", z.ZodTypeAny, {
